...
public final class StockServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.trading.stock.StockPriceRequest,
      com.trading.stock.StockPriceResponse> getGetStockPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStockPrice",
      requestType = com.trading.stock.StockPriceRequest.class,
      responseType = com.trading.stock.StockPriceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.trading.stock.StockPriceRequest,
      com.trading.stock.StockPriceResponse> getGetStockPriceMethod() {
    io.grpc.MethodDescriptor<com.trading.stock.StockPriceRequest, com.trading.stock.StockPriceResponse> getGetStockPriceMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetStockPriceMethod = StockServiceGrpc.getGetStockPriceMethod) == null) {
          StockServiceGrpc.getGetStockPriceMethod = getGetStockPriceMethod =
              io.grpc.MethodDescriptor.<com.trading.stock.StockPriceRequest, com.trading.stock.StockPriceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetStockPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.trading.stock.StockPriceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.trading.stock.StockPriceResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.trading.stock.PriceUpdate> getGetPriceUpdatesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPriceUpdates",
      requestType = com.google.protobuf.Empty.class,
      responseType = com.trading.stock.PriceUpdate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.trading.stock.PriceUpdate> getGetPriceUpdatesMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.trading.stock.PriceUpdate> getGetPriceUpdatesMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetPriceUpdatesMethod = StockServiceGrpc.getGetPriceUpdatesMethod) == null) {
          StockServiceGrpc.getGetPriceUpdatesMethod = getGetPriceUpdatesMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.trading.stock.PriceUpdate>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.trading.stock.PriceUpdate.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getStockPrice(com.trading.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.trading.stock.StockPriceResponse> responseObserver) {
    ...
    default void getPriceUpdates(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<com.trading.stock.PriceUpdate> responseObserver) {
  ...
  public static final class StockServiceStub
     ...
     * </pre>
     */
    public void getStockPrice(com.trading.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.trading.stock.StockPriceResponse> responseObserver) {
  ...
  public static final class StockServiceBlockingStub
     ...
     * </pre>
     */
    public com.trading.stock.StockPriceResponse getStockPrice(com.trading.stock.StockPriceRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.trading.stock.PriceUpdate> getPriceUpdates(
  ...
  public static final class StockServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.trading.stock.StockPriceResponse> getStockPrice(
        com.trading.stock.StockPriceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_PRICE:
          serviceImpl.getStockPrice((com.trading.stock.StockPriceRequest) request,
              (io.grpc.stub.StreamObserver<com.trading.stock.StockPriceResponse>) responseObserver);
          break;
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.trading.stock.StockPriceResponse>(
  ...
  private static abstract class StockServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.trading.stock.StockServiceOuterClass.getDescriptor();
    }
