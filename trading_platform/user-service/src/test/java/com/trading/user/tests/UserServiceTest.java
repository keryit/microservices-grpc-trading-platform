...
public class UserServiceTest {
    ...
    public void userInformationTest() {
        ...
        Assertions.assertEquals(7000, response.getBalance());
    ...
    public void buySellTest() {
        ...
        //validate balance
        Assertions.assertEquals(4500, buyResponse.getBalance());
        ...
        var sellRequest = buyRequest.toBuilder()
                .setAction(TradeAction.SELL).setPrice(105)
                .build();
        var sellResponse = this.stub.tradeStock(sellRequest);

        //validate balance
        Assertions.assertEquals(5025, sellResponse.getBalance());
    }
